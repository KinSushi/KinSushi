...
| Market | Why it fits |
|---|---|
| Banking | data quality, reconciliation, production support, SQL |
| Insurance / health insurance | claims-style controls, data quality, monitoring |
| Reinsurance / risk | risk data validation and governance mindset |
| Pharma / medtech | regulated data, validation, auditability |
| Financial infrastructure | migration, SQL, data controls, operational docs |
| Big-tech data platforms | reproducible pipelines, CI, tests, observability |
...
|---|---|
| README | Present |
| Synthetic data generator | Present |
| PostgreSQL schema | Present |
| Docker Compose | Present |
| SQL quality checks | Present |
